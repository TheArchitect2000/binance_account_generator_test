/**
 * This program creates bulk customer and binance account.
 */

// Binance required packages
...
async function add(x){
    ...
    let account = await createBinanceAccount();
...
async function createBinanceAccount() {
